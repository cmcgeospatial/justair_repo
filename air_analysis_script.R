...
# Create a list of the packages to load
my_air_packages <- c("dplyr", "openair", "tidyverse", "openairmaps", "worldmet", "lubridate", "readr", "colorspace")

# Load all packages/libraries at once
lapply(my_air_packages, library, character.only = TRUE)
